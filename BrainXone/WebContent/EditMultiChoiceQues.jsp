...
<%
	HashMap<String, Integer> options = ques.displayAnswers(stmt);
			...
			for (String str : options.keySet()) {
				...
				out.print("<input type = 'text' name = 'options" + (i + 1) + "' value = '" + str + "'>");
				int isValid = options.get(str);
				if(isValid == 1){
					out.print("<input type = 'radio' name= 'isValid" + (i + 1) + "' value = '1' checked> YES &nbsp; <input type = 'radio'  name='isValid"
							+ (i + 1) + "' value = '0'> NO <br>");
				}else{
					out.print("<input type = 'radio' name= 'isValid" + (i + 1) + "' value = '1'> YES &nbsp; <input type = 'radio'  name='isValid"
